       ...
       extends LDAPSDKTestCase
{
         ...
         throws Exception
  {
    ...
    if (path.contains("package-info.java"))
    {
      ...
      {
        " * <BLOCKQUOTE>",
        " *   <B>NOTE:</B>  This package is part of the Commercial Edition " +
             "of the",
        " *   UnboundID LDAP SDK for Java.  It is not available for use in " +
             "applications",
        " *   that include only the Standard Edition of the LDAP SDK, and is " +
             "not",
    ...
    else
    {
      ...
      {
        " * <BLOCKQUOTE>",
        " *   <B>NOTE:</B>  This class is part of the Commercial Edition of " +
             "the UnboundID",
        " *   LDAP SDK for Java.  It is not available for use in " +
             "applications that",
        " *   include only the Standard Edition of the LDAP SDK, and is not " +
             "supported for",
