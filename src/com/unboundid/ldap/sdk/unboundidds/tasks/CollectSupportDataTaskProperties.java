       ...
       implements Serializable
{
  ...
  /**
   * Specifies the value of a flag that indicates whether the support data
   * archive may include a replication state dump, which mayh be several
   * megabytes in size.
   *
   ...
   *                            {Wcode null} if the property should not be
   *                            specified when the task is created (in which
  ...
  public void setLogDurationMillis(final Long logDurationMillis)
  {
    ...
    {
      this.logDuration = DurationArgument.nanosToDuration(
  ...
  /**
   * Retrieves the task ID that should be usedfor the task.
   *
   ...
   * running.
   *
   * @return  The earliest time tha tthe task should be eligible to start
   ...
   *                        successfully.  It amy be {@code null} or empty if
   *                        no email notification should be sent onan
   *                        unsuccessful completion.
   */
   ...
   *          administrative alert notification when the task starts running,
   *          or {@code null} if the property should not be specifeid when the
   ...
   *          specifeid when the task is created (and the server will default to
