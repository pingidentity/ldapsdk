...
rem Copyright 2009-2017 UnboundID Corp.
rem All Rights Reserved.
rem
rem -----
rem
rem Copyright (C) 2009-2017 UnboundID Corp.
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-ce.jar;%CLASSPATH%" com.unboundid.ldap.sdk.unboundidds.examples.SummarizeAccessLog %*
