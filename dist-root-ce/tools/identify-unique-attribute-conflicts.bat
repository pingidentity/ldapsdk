...
rem -----
rem
rem Copyright (C) 2013-2017 UnboundID Corp.
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-ce.jar;%CLASSPATH%" com.unboundid.ldap.sdk.examples.IdentifyUniqueAttributeConflicts %*
